        ...
        <div className="bg-white border-5 border-candy-ink rounded-[2rem] p-6 sm:p-8 shadow-[8px_8px_0_0_#2B2D42] text-left space-y-6 transform rotate-1">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="w-full bg-[#FFF] text-left p-4 border-4 border-candy-ink rounded-2xl shadow-[4px_4px_0_0_#2B2D42] opacity-75 cursor-not-allowed hover:bg-red-50 transition-all select-none group relative overflow-hidden">
              <span className="font-extrabold text-candy-pink mr-1">A)</span> Đã
              bị &quot;bay màu&quot; khỏi hệ thống
            ...
            {/* Option C - Bait */}
            <div className="w-full bg-[#FFF] text-left p-4 border-4 border-candy-ink rounded-2xl shadow-[4px_4px_0_0_#2B2D42] opacity-75 cursor-not-allowed hover:bg-red-50 transition-all select-none group relative overflow-hidden">
              <span className="font-extrabold text-candy-pink mr-1">C)</span> Đi
              lạc vào vòng bo sinh tồn
              <div className="absolute right-3 top-3.5 opacity-0 group-hover:opacity-100 transition-opacity">
                <svg
                  className="w-6 h-6 text-candy-red"
                  viewBox="0 0 24 24"
            ...
            >
              <span className="font-black text-candy-yellow mr-1">D)</span> Quay
              lại trang chủ làm trận mới!
