...
export const LeaveRoomModal: React.FC<LeaveRoomModalProps> = ({
  ...
  return (
    <Modal
      ...
      description={
        isHost
          ? "Bạn là Host. Nếu bạn rời phòng, phòng sẽ bị giải tán và tất cả người chơi sẽ bị đá ra."
          : "Bạn có chắc chắn muốn rời phòng này? Bạn sẽ cần nhập lại mã phòng để quay lại."
      }
      closeLabel="Đóng"
    >
        ...
        <div className="flex items-start gap-3 p-3 rounded-xl bg-candy-cloud border-[3px] border-candy-ink">
          ...
          <p className="text-sm font-semibold leading-relaxed text-candy-ink">
            {isHost
              ...
              : "Tiến trình của bạn trong phòng này sẽ bị mất."}
          </p>
        </div>
